            ...
            <div class="col-12   col-xl-6">
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="mb-4">Category: {{$data -> name}} </h5>
                        <form class="row g-3" method="POST" action="{{route('admin.categories.update', $data -> id  )}}"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-check form-switch form-switch-{{ $color }}">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                   ...
                                                   @if ($data -> is_status == 1 ) checked @endif>
                            ...
                            <div class="col-md-12">
                                ...
                                <img src="{{\Storage::url( $data -> thumbnail_img ) }}" style=" width: 200px">
                                <input type="file" value="{{ $data -> thumbnail_img}}" class="form-control" id="inputGroupFile03" name="thumbnail_img">
                                @error('thumbnail_img')
                                <span class=" text-danger"> {{ $message }}</span>
                                @enderror
                            </div>
