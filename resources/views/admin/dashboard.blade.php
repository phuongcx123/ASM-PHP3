                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-5">
                                <div class="welcome-back-img pt-4">
                                    <img src="{{asset('theme/admin/assets/images/gallery/welcome-back-3.png')}}"
                                         height="180" alt="">
                                </div>
                            </div>
                        </div><!--end row-->
                ...
                <div class="card w-100 rounded-4">
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between mb-1">
                            ...
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle-nocaret options dropdown-toggle"
                ...
                <div class="card w-100 rounded-4">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column justify-content-between gap-4">
                            <div class="d-flex align-items-center gap-4">
                                <div class="d-flex align-items-center gap-3 flex-grow-1">
                                    <img src="{{asset('theme/admin/assets/images/apps/17.png')}}" width="32" alt="">
                        ...
                        <span
                            ...
                            <div class="d-flex align-items-center gap-4">
                                <div class="d-flex align-items-center gap-3 flex-grow-1">
                                    <img src="{{asset('theme/admin/assets/images/apps/18.png')}}" width="32" alt="">
                        ...
                        <span
                            ...
                            <div class="d-flex align-items-center gap-4">
                                <div class="d-flex align-items-center gap-3 flex-grow-1">
                                    <img src="{{asset('theme/admin/assets/images/apps/19.png')}}" width="32" alt="">
                        ...
                        <span
                            ...
                            <div class="d-flex align-items-center gap-4">
                                <div class="d-flex align-items-center gap-3 flex-grow-1">
                                    <img src="{{asset('theme/admin/assets/images/apps/20.png')}}" width="32" alt="">
                        ...
                        <span
                            ...
                            <div class="d-flex align-items-center gap-4">
                                <div class="d-flex align-items-center gap-3 flex-grow-1">
                                    <img src="{{asset('theme/admin/assets/images/apps/05.png')}}" width="32" alt="">
                        ...
                        <span
                            ...
                            <div class="d-flex align-items-center gap-4">
                                <div class="d-flex align-items-center gap-3 flex-grow-1">
                                    <img src="{{asset('theme/admin/assets/images/apps/08.png')}}" width="32" alt="">
                        ...
                        <span
                            ...
                            <div class="d-flex align-items-center gap-4">
                                <div class="d-flex align-items-center gap-3 flex-grow-1">
                                    <img src="{{asset('theme/admin/assets/images/apps/07.png')}}" width="32" alt="">
                ...
                <div class="card w-100 rounded-4">
                    ...
                    <div class="card-body p-0">
                        <div class="user-list p-3">
                            <div class="d-flex flex-column gap-3">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{asset('theme/admin/assets/images/avatars/01.png')}}" width="45"
                                         height="45"
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{asset('theme/admin/assets/images/avatars/02.png')}}" width="45"
                                         height="45"
                                         class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{asset('theme/admin/assets/images/avatars/03.png')}}" width="45"
                                         height="45"
                                         class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{asset('theme/admin/assets/images/avatars/04.png')}}" width="45"
                                         height="45"
                                         class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{asset('theme/admin/assets/images/avatars/05.png')}}" width="45"
                                         height="45"
                                         class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{asset('theme/admin/assets/images/avatars/06.png')}}" width="45"
                                         height="45"
                                         class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{asset('theme/admin/assets/images/avatars/08.png')}}" width="45"
                                         height="45"
                                         class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                            ...
                            <table class="table align-middle">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="">
                                                <img src="{{asset('theme/admin/assets/images/top-products/01.png')}}"
                                    ...
                                    <td>$149</td>
                                    <td>Julia Sunota</td>
                                    <td><p class="dash-lable mb-0 bg-success bg-opacity-10 text-success rounded-2">
                                            Completed</p></td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="">
                                                <img src="{{asset('theme/admin/assets/images/top-products/02.png')}}"
                                                     class="rounded-circle"
                                                     width="50" height="50" alt="">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="">
                                                <img src="{{asset('theme/admin/assets/images/top-products/03.png')}}"
                                                     class="rounded-circle"
                                                     width="50" height="50" alt="">
                                            </div>
                                    ...
                                    <td>$124</td>
                                    <td>Julia Sunota</td>
                                    <td><p class="dash-lable mb-0 bg-warning bg-opacity-10 text-warning rounded-2">
                                            Pending</p></td>
                                    <td>
                                        <div class="d-flex align-items-center gap-1">
                                            <p class="mb-0">4.0</p>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="">
                                                <img src="{{asset('theme/admin/assets/images/top-products/04.png')}}"
                                                     class="rounded-circle"
                                                     width="50" height="50" alt="">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="">
                                                <img src="{{asset('theme/admin/assets/images/top-products/06.png')}}" class="rounded-circle"
                                                     width="50" height="50" alt="">
                                            </div>
                                    ...
                                    <td>$389</td>
                                    <td>Julia Sunota</td>
                                    <td><p class="dash-lable mb-0 bg-danger bg-opacity-10 text-danger rounded-2">
                                            Canceled</p></td>
                                    <td>
                                        <div class="d-flex align-items-center gap-1">
                                            <p class="mb-0">2.0</p>
