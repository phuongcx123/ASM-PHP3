  ...
  <!--favicon-->
  <link rel="icon" href="{{ asset('theme/client/assets/images/logo/logo-icon.svg') }}" type="image/png">
  <!-- loader-->
  ...
  <link href="{{asset('theme/admin/sass/dark-theme.css')}}" rel="stylesheet">
  <link href="{{asset('theme/admin/sass/blue-theme.css')}}" rel="stylesheet">
